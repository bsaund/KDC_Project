...
%     costPhases(k) = heaviside((distToLine+.02))*((distToLine+.02)*500)^2;% ok
%     costPhases(k) = 100*heaviside((distToLine+.02))*((distToLine+.02)*500)^2; % ok too
%         costPhases(k) = 1000*heaviside((distToLine+.1))*((distToLine+.1)*1000)^2; % ?
